...
function update_sanpham($tensp, $giasp, $anhsp, $mota, $iddm, $id) {
    if ($anhsp != "") {
        $sql = "update sanpham set ten_sanpham='" . $tensp . "',gia_sanpham='" . $giasp . "',img='" . $anhsp . "',mota='" . $mota . "',id_danhmuc='" . $iddm . "' where id_sanpham=" . $id;
    } else {
        $sql = "update sanpham set ten_sanpham='" . $tensp . "',gia_sanpham='" . $giasp . "',mota='" . $mota . "',id_danhmuc='" . $iddm . "' where id_sanpham=" . $id;
    }
    pdo_execute($sql);
}
